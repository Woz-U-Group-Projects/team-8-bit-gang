...
export function createDashboardLayer(font, playerEnv) {
    ...
    let scoreShow = localStorage.getItem('score').toString;
    ...
    return function drawDashboard(context) {
        ...
        font.print(username, context, 16, LINE1);
        
        font.print(score.toString().padStart( 6, '0'), context, 16, LINE2) ? scoreShow : score;
